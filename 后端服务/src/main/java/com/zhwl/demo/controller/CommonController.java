...
import com.zhwl.ruoyi.common.utils.file.FileUploadUtils;
import com.zhwl.ruoyi.common.utils.file.FileUtils;
...
public class CommonController {
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request)
    {
        try
        {
            ...
            String realFileName =  format.format(cal.getTime()) + fileName.substring(fileName.indexOf("_") + 1);
