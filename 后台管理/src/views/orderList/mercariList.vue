        ...
        <div v-if="deviceType === 'pc'">
            <div class="search between">
                ...
                <div class="flex">
                    ...
                    <el-button type="primary" @click="queryMercariOrderList()">查询</el-button>
            ...
            <div class="tabs">
                <el-radio-group v-model="tabPosition" style="margin-bottom: 30px;" @change="onTabClick">
                    ...
                    <el-radio-button :label="3">申请发货</el-radio-button>
                    <el-radio-button :label="4">待付尾款</el-radio-button>
            ...
            <el-table :data="tableData" border
                ...
                <el-table-column v-for="item in column1" :key="item.index"  header-align="center"  align="center"
                ...
                <el-table-column v-for="item in column2" :key="item.index"  header-align="center"  align="center"
                    :prop="item.prop" :label="item.label" :width="item.width">
                </el-table-column>
        ...
        <div class="page_m" v-else>
            ...
            <div class="search_m">
                ...
                <div class="flex seatchOptions">
                    ...
                    <el-button type="primary" size="mini" @click="queryMercariOrderList()">查询</el-button>
...
<script>
import {queryRate, exportMercariOrder, queryMercariOrderList, updataMercariOrderStatus, orderRefund, countCost, deleteMercariOrderList} from "@/http/api"
...
export default {
    ...
    methods: {
        ...
        async confirmGot(){
            ...
            if(code === 0){
                this.handleClose()
                this.changeStatus(this.currentRow.id, 2, this.currentRow.userid)
            }else{
                this.$message.error(msg)
            }
            this.loading = false
        ...
        async orderRefund(row){
            this.$confirm('此操作会给用户退款, 是否继续?', '提示', {
                confirmButtonText: '确定',
                cancelButtonText: '取消',
                type: 'warning'
            }).then(async () => {
                const {transactionid = "", price = 0, orderid = ""} = row
                this.loading = true
                const params = {
                    price,
                    orderid,
        ...
        async exportFile(){
            ...
            const res = await exportMercariOrder(params)
            fileDownload(res, `煤炉待发货列表导出.xlsx`);
            this.$message.success("下载成功");
            this.exportLoading = false
        },
        changeStatus(id, type, userid){
        ...
        async queryMercariOrderList(){
            ...
            const params = {
                ...
                type: this.tabPosition === 0 ? '' :  this.tabPosition,
            }
