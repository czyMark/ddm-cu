...
<script>
import {queryYahooOrderList, updataYahooOrderStatus, countYahooCost, sendYahooGood, fixYahooPrice, exportYahooOrder, deleteYahooOrderList} from "@/http/api"
...
export default {
    ...
    methods: {
        async confirmGot(){
            ...
            if(code === 0){
                this.handleClose()
                this.changeStatus(this.currentRow.id, 5, this.currentRow.userid)
            }else{
